...
```
ronswanson <command> [arguments] [flags]
```

Run `ronswanson <command> --help` for the full flag list on any command. This
...
per operation you declare in `ronswanson/domain.go`.
